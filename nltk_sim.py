...
print courses_name[sort_sims[1][0]].encode('utf-8')   #看下实际最相似的数据叫什么
print courses_name[sort_sims[2][0]].encode('utf-8')   #看下实际最相似的数据叫什么
print courses_name[sort_sims[3][0]].encode('utf-8')   #看下实际最相似的数据叫什么